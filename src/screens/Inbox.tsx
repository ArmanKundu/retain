    ...
    <div className="mx-auto w-full max-w-[min(920px,100%)] px-6 sm:px-9 pb-14">
      ...
      <header className="mb-6">
        ...
        <p className="mt-1 text-[13.5px] text-[var(--ink-dim)]">
          ⌘⇧Space captures from anywhere. Sort it out here when you have a
          moment.
        </p>
      </header>
            ...
            captures.length === 0 ? (
              <div className="flex flex-col items-center px-6 py-14 text-center">
                ...
                <div className="mt-1.5 max-w-[380px] text-[13px] leading-relaxed text-[var(--ink-faint)]">
                  Press ⌘⇧Space from any app and type. It saves and disappears —
                  sort it out later.
                </div>
              </div>
            ) : (
              <Empty
                title="No tasks yet"
                body="Triage a capture above to make your first one."
              />
            )
          ) : (
